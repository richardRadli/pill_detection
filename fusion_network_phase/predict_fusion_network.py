...
class PredictFusionNetwork:
    ...
    def __init__(self):
        ...
        self.plot_dir = (
            self.create_save_dirs(
                fusion_network_paths(
                    ...
                    network_type=self.fusion_network_type).get("plotting_folder")
            )
        )
        ...
        self.prediction_dir = (
                fusion_network_paths(
                    dataset_type=self.dataset_type,
                    network_type=self.fusion_network_type).get("prediction_folder")
        )
    ...
    def main(self) -> None:
        ...
        query_dirs = {
            "con":
                substream_paths().get("Contour").get(self.dataset_type).get("CNN").get("test").get("query"),
            "lbp":
                substream_paths().get("LBP").get(self.dataset_type).get("CNN").get("test").get("query"),
            "rgb":
                substream_paths().get("RGB").get(self.dataset_type).get("CNN").get("test").get("query"),
            "tex":
                substream_paths().get("Texture").get(self.dataset_type).get("CNN").get("test").get("query")
        }

        reference_dirs = {
            "con":
                substream_paths().get("Contour").get(self.dataset_type).get("CNN").get("test").get("ref"),
            "lbp":
                substream_paths().get("LBP").get(self.dataset_type).get("CNN").get("test").get("ref"),
            "rgb":
                substream_paths().get("RGB").get(self.dataset_type).get("CNN").get("test").get("ref"),
            "tex":
                substream_paths().get("Texture").get(self.dataset_type).get("CNN").get("test").get("ref")
        }

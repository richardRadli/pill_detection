...
if __name__ == "__main__":
    images_path = sorted(glob("D:/storage/pill_detection/datasets/nih/Customer/images_original/*"))
    mask_path = sorted(glob("D:/storage/pill_detection/datasets/nih/Customer/mask_images/*"))
    output_path = "D:/storage/pill_detection/datasets/nih/Customer/images"

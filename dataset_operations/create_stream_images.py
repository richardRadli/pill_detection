...
class CreateStreamImages:
    ...
    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def create_contour_images(args: Tuple[np.ndarray, str, int, int, int]) -> None:
        """
    ...
    # ------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def create_texture_images(args: Tuple[np.ndarray, str, Tuple[int, int]]) -> None:
        """
        ...
        Args:
            args (Tuple[numpy.ndarray, str, Tuple[int, int]]): A tuple containing the following elements:

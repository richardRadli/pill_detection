...
def main(replace_files: bool = False) -> None:
    ...
    images_path = DATASET_PATH.get_data_path("")
    labels_path = DATASET_PATH.get_data_path("")

    train_images_path = DATASET_PATH.get_data_path("")
    train_labels_path = DATASET_PATH.get_data_path("")
    val_images_path = DATASET_PATH.get_data_path("")
    val_labels_path = DATASET_PATH.get_data_path("")
    test_images_path = DATASET_PATH.get_data_path("")
    test_labels_path = DATASET_PATH.get_data_path("")

...
if __name__ == "__main__":
    images_path = sorted(glob(os.path.join(DATASET_PATH.get_data_path("ogyei_reference_images"), "*")))
    mask_path = sorted(glob(os.path.join(DATASET_PATH.get_data_path("ogyei_reference_mask_images"), "*")))
    output_path = "D:/storage/pill_detection/datasets/ogyei/Reference/images_seg"

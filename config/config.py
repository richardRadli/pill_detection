...
class ConfigStreamNetwork:
    def __init__(self):
        ...
        self.parser.add_argument("--dataset_type", type=str, default="ogyei", choices=["cure | ogyei | nih"])
        self.parser.add_argument("--type_of_net", type=str, default="EfficientNetV2", choices=["EfficientNetV2"])
        self.parser.add_argument("--type_of_stream", type=str, default="Texture",
                                 choices=["Contour | LBP | RGB | Texture"])

        self.parser.add_argument("--type_of_loss_func", type=str, default="hmtl", choices="dmtl |  hmtl",
                                 help="dmtl - dynamic margin triplet loss | hmtl - hard mining triplet loss")

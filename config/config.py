...
class ConfigTrainingUnet:
    def __init__(self):
        ...
        self.parser.add_argument('--img_scale', '-s', type=float, default=0.35, help='Downscaling factor of the images')
...
class ConfigTestingUnet:
    def __init__(self):
        ...
        self.parser.add_argument('--scale', '-s', type=float, default=0.35,

    ...
    network_config = {
        "Contour": {
            ...
            "model_weights_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("weights_efficient_net_v2_contour"),
            ...
            "logs_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("logs_efficient_net_v2_contour"),
            ...
            "learning_rate": {
                "CNN": cfg.learning_rate_cnn_con,
                "EfficientNet": cfg.learning_rate_en_con,
                "EfficientNetV2": cfg.learning_rate_en_con,
                "EfficientNetSelfAttention": cfg.learning_rate_ensa_con
            }.get(cfg.type_of_net, cfg.learning_rate_cnn_con),
            "image_size": {
                "CNN": cfg.img_size_cnn,
                "EfficientNet": cfg.img_size_en,
                "EfficientNetV2": cfg.img_size_en,
                "EfficientNetSelfAttention": cfg.img_size_ensa
        ...
        "LBP": {
            ...
            "model_weights_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("weights_efficient_net_v2_lbp"),
            ...
            "logs_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("logs_efficient_net_v2_lbp"),
            ...
            "learning_rate": {
                "CNN": cfg.learning_rate_cnn_lbp,
                "EfficientNet": cfg.learning_rate_en_lbp,
                "EfficientNetV2": cfg.learning_rate_en_lbp,
                "EfficientNetSelfAttention": cfg.learning_rate_ensa_lbp
        ...
        "RGB": {
            ...
            "model_weights_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("weights_efficient_net_v2_rgb"),
            ...
            "logs_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("logs_efficient_net_v2_rgb"),
            ...
            "learning_rate": {
                "CNN": cfg.learning_rate_cnn_rgb,
                "EfficientNet": cfg.learning_rate_en_rgb,
                "EfficientNetV2": cfg.learning_rate_en_rgb,
                "EfficientNetSelfAttention": cfg.learning_rate_ensa_rgb
        ...
        "Texture": {
            ...
            "model_weights_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("weights_efficient_net_v2_texture"),
            ...
            "logs_dir": {
                ...
                "EfficientNetV2": DATA_PATH.get_data_path("logs_efficient_net_v2_texture"),
            ...
            "learning_rate": {
                "CNN": cfg.learning_rate_cnn_tex,
                "EfficientNet": cfg.learning_rate_en_tex,
                "EfficientNetV2": cfg.learning_rate_en_tex,
                "EfficientNetSelfAttention": cfg.learning_rate_ensa_tex
...
# ------------------------------------------------------------------------------------------------------------------
def get_main_network_config(cfg) -> Dict:
    """
    ...
    network_configs = {
        ...
        'EfficientNetV2': {
            'prediction_folder': DATA_PATH.get_data_path("predictions_efficient_net_v2"),
            'plotting_folder': IMAGES_PATH.get_data_path("plotting_efficient_net_v2"),
            'ref_vectors_folder': DATA_PATH.get_data_path("reference_vectors_efficient_net_v2")
        },
        'EfficientNetSelfAttention': {

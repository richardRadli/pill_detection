...
def fusion_network_config(network_type) -> Dict:
    ...
    network_configs = {
        "EfficientNetMultiHeadAttention": {
            ...
            'prediction_folder': {
                "ogyei":
                    DATA_PATH.get_data_path("predictions_fusion_network_efficient_net_multi_head_attention_ogyei"),
            },
            'plotting_folder': {
                "ogyei":
                    IMAGES_PATH.get_data_path("plotting_fusion_network_efficient_net_multi_head_attention_ogyei"),
            },
            'confusion_matrix': {
                "ogyei":
                    IMAGES_PATH.get_data_path("conf_mtx_fusion_network_efficient_net_multi_head_attention_ogyei"),
            },
            'ref_vectors_folder': {
                "ogyei":

...
class Images(_Const):
    dirs_images = {
        ...
        "rgb": "images/reference/rgb",
        "contour": "images/reference/contour",
        "texture": "images/reference/texture",

        "unet_out": "images/unet/unet_out",
        "unet_compare": "images/unet/unet_compare",

        "query/rgb": "images/query/rgb",
        "query/contour": "images/query/contour",
        "query/texture": "images/query/texture",
        ...
        "prediction_stream_network": "images/prediction/prediction_stream_network",
        "prediction_efficient_net": "images/prediction/prediction_efficient_net",
        "prediction_fusion_network": "images/prediction/prediction_fusion_network",
        "prediction_efficient_net_self_attention": "images/prediction/prediction_efficient_net_self_attention",
...
class Data(_Const):
    dirs_data = {
        ...
        "weights_efficient_self_attention_net_rgb": "data/weights/weights_efficient_self_attention_net_rgb",
        "weights_efficient_self_attention_net_contour": "data/weights/weights_efficient_self_attention_net_contour",
        "weights_efficient_self_attention_net_texture": "data/weights/weights_efficient_self_attention_net_texture",
